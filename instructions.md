...
* **Game Proposal:** Week 4 Monday 21th October 2024 23:59.
* **Phase -1 Delivery:** Week 5 Monday 28th October 2024 23:59.
* **Phase 1 Delivery:** Week 9 Saturday 23th November 2024 23:59.
* **Phase 1 Discussion:** During the tutorials in Week 9.
* **Phase 2 Delivery:** Week 12 Saturday 14th December 2024 23:59.
* **Phase 2 Discussion:** During the tutorial in Week 12.

---

## Game Proposal Document

By Week 4 Monday 21th October 2024 23:59, you should submit a game proposal. It should contain a game name, a paragraph describing the game and an image demonstrating the game idea. The description should describe how the game will be played and what is the goal of the game. Don’t forget to add the team member names, IDs and team number. Some example proposals are included in the appendix. Only one member of each team needs to deliver the game proposal on Google Classroom.

---

# Phase -1
## Requirements
This phase is individual, so each student should do and deliver this requirement alone. For this phase, you only need to:

1. Run the starter project 
2. Change the window name (title). The Window name will be your name.
3. Change the background (clear) color. The color will be a function of the student code as shown below where `id` is your id.

```
      color.r = ((id /   1) % 16) / 16.0
      color.g = ((id /  16) % 16) / 16.0
      color.b = ((id / 256) % 16) / 16.0
      color.a = 1.0
```
...
Phase -1 should be delivered on Monaday 28th October 2024 23:59. It should be delivered on Google Classroom.

The delivered file is a single screenshot showing that the project is running and that you changed the window title and the background color according to the requirements.
...
Phase 1 should be delivered on Saturday 23th November 2024 23:59 and discussed in the tutorial during Week 9.
...
* A sky.
* At least one postprocessing effect that we was not implemented or provided in Phase 1.
* 3D motion.
...
Phase 2 should be delivered on Saturday 14th December 2024 23:59 and discussed in the tutorial during Week 12.
